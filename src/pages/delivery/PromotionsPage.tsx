    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <header className="bg-white px-4 pt-6 pb-4 sticky top-0 z-30 shadow-sm space-y-4">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-xl font-black text-gray-900">العروض والخصومات</h1>
        </div>
                ...
                <div className="p-6 space-y-4">
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-xs font-bold text-emerald-600">{offer.store}</p>
                    </div>
                  ...
                  <div className="flex items-center gap-3 pt-2">
                    <div className="flex-1 bg-gray-50 border-2 border-dashed border-gray-200 rounded-2xl p-3 flex items-center justify-between">
                      <span className="text-xs font-black text-gray-400 uppercase tracking-widest">كود الخصم</span>
                      <span className="font-black text-gray-900">{offer.code}</span>
                    </div>
                    <button className="h-12 px-6 bg-emerald-600 text-white rounded-2xl font-black text-xs shadow-lg shadow-emerald-100 active:scale-95 transition-all">
                      تطبيق العرض
                    </button>
                  </div>
                </div>
