  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-32">
      ...
      <header className="bg-white px-4 pt-6 pb-4 sticky top-0 z-30 shadow-sm flex items-center gap-4">
        ...
        <h1 className="text-xl font-black text-gray-900">طريقة الدفع</h1>
      </header>

      <main className="p-6 space-y-8">
        <div className="space-y-2">
          <h2 className="text-sm font-black text-gray-400 uppercase tracking-widest px-2">اختر طريقة الدفع المفضلة</h2>
        ...
        <div className="space-y-4">
            ...
            >
              <div className="flex items-center gap-5">
                <div className={`w-16 h-16 rounded-2xl flex items-center justify-center transition-all ${
                  selectedMethod === method.id ? "bg-emerald-600 text-white" : method.color
                }`}>
                  <method.icon size={32} />
                </div>
                <div className="text-right">
                  <h3 className="font-black text-gray-900 text-lg">{method.label}</h3>
              ...
              <div className={`w-8 h-8 rounded-full border-2 flex items-center justify-center transition-all ${
                selectedMethod === method.id ? "border-emerald-600 bg-emerald-600 shadow-lg shadow-emerald-200" : "border-gray-200"
              }`}>
                {selectedMethod === method.id && (
          ...
          {/* Add New Card Option */}
          <button className="w-full p-6 rounded-[32px] border-2 border-dashed border-gray-200 flex items-center justify-center gap-3 text-gray-400 hover:border-emerald-300 hover:text-emerald-600 transition-all group">
        ...
        <div className="flex items-center gap-4 p-5 bg-emerald-50 rounded-[28px] border border-emerald-100">
          ...
          <div className="flex-1">
            <h4 className="text-xs font-black text-emerald-900">دفع آمن 100%</h4>
            <p className="text-[10px] font-bold text-emerald-600 leading-relaxed mt-0.5">
