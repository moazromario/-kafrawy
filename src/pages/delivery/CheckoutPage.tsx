  ...
  return (
    <div className="min-h-screen bg-[#F0F2F5] pb-44">
      ...
      <header className="bg-white px-4 pt-12 pb-4 sticky top-0 z-30 shadow-sm flex items-center gap-4">
        ...
        <h1 className="text-xl font-black text-[#050505]">الدفع وإتمام الطلب</h1>
      </header>
      ...
      <main className="p-4 space-y-8">
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between px-2">
            <h2 className="text-[10px] font-black text-gray-400 uppercase tracking-widest">عنوان التوصيل</h2>
            <button className="text-xs font-black text-[#1877F2] flex items-center gap-1">
              <Plus size={14} />
              <span>إضافة جديد</span>
            </button>
          </div>
          <div className="bg-white rounded-[32px] p-6 shadow-sm border border-gray-100 flex items-center justify-between group cursor-pointer hover:border-blue-200 transition-all">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 bg-blue-50 rounded-2xl flex items-center justify-center text-[#1877F2] group-hover:bg-[#1877F2] group-hover:text-white transition-all">
                <MapPin size={28} />
              </div>
              <div>
                <p className="font-black text-[#050505]">{currentAddress}</p>
                <p className="text-xs text-gray-400 font-bold mt-1">الشقة 4، الدور الثاني، عمارة 12</p>
              </div>
            </div>
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between px-2">
            <h2 className="text-[10px] font-black text-gray-400 uppercase tracking-widest">طريقة الدفع</h2>
            <button 
          ...
          <div 
            onClick={() => navigate("/delivery/payment")}
            className="bg-white rounded-[32px] p-6 shadow-sm border border-gray-100 flex items-center justify-between group cursor-pointer hover:border-blue-200 transition-all"
          >
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 bg-blue-50 rounded-2xl flex items-center justify-center text-[#1877F2] group-hover:bg-[#1877F2] group-hover:text-white transition-all">
        ...
        {/* Order Items Summary */}
        <section className="space-y-4">
          <h2 className="text-[10px] font-black text-gray-400 uppercase px-2 tracking-widest">ملخص الطلب</h2>
          <div className="bg-white rounded-[40px] p-8 shadow-sm border border-gray-100 space-y-6">
            <div className="space-y-4">
              {cart.map((item, idx) => (
                <div key={idx} className="flex justify-between items-center group">
                  <div className="flex items-center gap-4">
                    <div className="w-10 h-10 bg-gray-50 rounded-xl flex items-center justify-center text-xs font-black text-[#1877F2] border border-gray-100 group-hover:bg-[#1877F2] group-hover:text-white transition-all">
                      {item.quantity}x
                    </div>
                    <div>
                      <span className="font-black text-[#050505] block">{item.name}</span>
                      <span className="text-[10px] font-bold text-gray-400">سعر الوحدة: {item.price} ج.م</span>
                    </div>
                  </div>
                  <span className="font-black text-[#050505]">{item.price * item.quantity} ج.م</span>
                </div>
              ))}
            </div>
              ...
              <div className="flex gap-3">
                <div className="relative flex-1">
                  ...
                  <input 
                    ...
                    className="w-full pr-12 pl-4 py-4 bg-gray-50 border border-transparent rounded-2xl text-sm font-bold focus:bg-white focus:border-[#1877F2] outline-none transition-all placeholder:text-gray-300"
                  />
                </div>
                <button className="px-6 bg-[#050505] text-white rounded-2xl font-black text-xs hover:bg-[#1877F2] transition-all">
                  تطبيق
                </button>
              </div>
            </div>
            ...
            <div className="pt-6 border-t border-gray-50 space-y-4">
              ...
              <div className="pt-4 flex justify-between items-end">
                <div className="space-y-1">
                  <div className="flex items-center gap-2 text-[#1877F2] bg-blue-50 w-fit px-3 py-1 rounded-full">
                    <Clock size={14} />
                ...
                <div className="text-right">
                  <p className="text-3xl font-black text-[#1877F2] tracking-tight">{total} <span className="text-sm">ج.م</span></p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Driver Notes */}
        <section className="space-y-4">
          <h2 className="text-[10px] font-black text-gray-400 uppercase px-2 tracking-widest">ملاحظات للمندوب</h2>
          <div className="relative">
            ...
            <textarea
              ...
              className="w-full pr-12 pl-4 py-4 bg-white border border-gray-100 rounded-[28px] text-sm font-bold focus:ring-2 focus:ring-[#1877F2] outline-none transition-all min-h-[100px] shadow-sm placeholder:text-gray-300"
            />
          </div>
        </section>

        {/* Security Info */}
        <div className="flex items-start gap-4 p-5 bg-blue-50 rounded-[28px] text-blue-700 border border-blue-100">
